                ...
                <Navbar dark expand="md">
                    <div className="container">
                        ...
                        <NavbarBrand className="mr-auto" href="/"> 
                            <img src="assets/images/logo.png" height="30" width="41" alt="Ristorante Con Fusin"/>
                        </NavbarBrand>
                    ...
                    <div className="container">
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                ...
                                <p>We take inspirtation from the worlds bests cuisines, and create a unique fusion experience. Our lipsmacking creations will tickle your culinary senses!</p> 
                            </div>
                        </div>
                    </div>
                </Jumbotron>
